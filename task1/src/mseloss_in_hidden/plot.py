...
def plot_history(history_path, plot_acc=True):
    ...
    train_loss = [l['lossB'] for l in history['train']]
    valid_loss = [l['lossB'] for l in history['valid']]
    ...
    print('Lowest Loss ', min([[l['lossB'], idx + 1] for idx, l in enumerate(history['valid'])]))

    if plot_acc:
        train_f1 = [l['accA'] for l in history['train']]
        valid_f1 = [l['accA'] for l in history['valid']]
        plt.figure(figsize=(7, 5))
        plt.title('Acc')
        ...
        print('Best acc', max([[l['accA'], idx + 1] for idx, l in enumerate(history['valid'])]))
